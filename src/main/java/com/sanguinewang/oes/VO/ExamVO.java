...
public class ExamVO {
    ...
    public ExamVO(Integer id, String name, LocalDateTime startTime, LocalDateTime endTime, String studentName, String teacherName, Integer teacherNumber, Integer studentNumber) {
        this.id = id;
        this.name = name;
